        ...
        <div class="card-body">
          ...
          <input type="hidden" name="id_barang" value="<?=$row['id_barang'];?>">           
            <div class="card-body">
              ...
              <div class="form-group row">
                <label for="jenis_bmn" class="col-sm-2 col-form-label">Jenis BMN</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?=$row['jenis_bmn']?>" name="jenis_bmn" placeholder="Masukan Jenis BMN.." required>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" value="<?= $row['kode_barang'] ?>" name="kode_barang" placeholder="Masukan Kode Barang.." required>
                </div>
              </div>
            </div>
            <!-- /.card-body -->
